...
This vignette introduces the main `araponga` workflow using a real example: estimating how widely bare-throated bellbirds — "araponga", in Brazil — open their beaks while producing some of the loudest sounds recorded among birds.
...
You can remind yourself of the package conventions at any time with `conventions()`.
...
`paired = TRUE` gives us a data frame with the possible pitches for each possible yaw. Let's extract per-yaw possible gapes and pool them:
